...
class MyApp(QMainWindow):
    ...
    def call_api_encrypt(self):
        url = "http://127.0.0.1:500/api/rsa/encrypt"
        payload = {
            "message": self.ui.txt_plain_text.topPlainText(),
            "key_type": "public"
        }
        try:
    ...
    def call_api_decrypt(self):
        url = "http://127.0.0.1:500/api/rsa/decrypt"
        payload = {
    ...
    def call_api_verify(self):
        url = "http://127.0.0.1:500/api/rsa/verify"
        payload = {
            "message": self.ui.txt_info.toPlainText(),
